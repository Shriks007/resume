...
from local_main import app, db
from local_forms import RegistrationForm, LoginForm, NewResumeForm, ShareResumeForm
    ...
    if request.method == 'POST':
        if form.validate_on_submit():
            ...
            if user and user.check_password(form.password.data):
                # Make session permanent when "remember me" is checked
