...
class NewResumeForm(FlaskForm):
    title = StringField('Resume Title', validators=[DataRequired(), Length(max=100)])
    template_id = SelectField('Template', validators=[DataRequired()], choices=[
...
class ShareResumeForm(FlaskForm):
    is_public = BooleanField('Make Resume Public')
